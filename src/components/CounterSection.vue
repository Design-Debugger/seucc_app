...
<template>
  <section
    id="counter-section"
    class="overflow-hidden py-20 bg-gradient-to-b from-gray-900 to-black"
  >
    <div class="container px-4 mx-auto">
      ...
      <div class="mx-auto mb-16 max-w-3xl text-center" data-aos="fade-up">
        ...
        <p class="text-lg text-gray-400">Growing stronger with every achievement</p>
      </div>
      ...
      <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <div class="mb-2">
            <span
              class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r"
              :class="`${stat.gradient}`"
            >
              {{ stat.current }}+
            </span>
...
<style scoped>
.text-gradient-from-blue-500 {
  @apply text-blue-500;
}
.text-gradient-from-purple-500 {
  @apply text-purple-500;
}
.text-gradient-from-green-500 {
  @apply text-green-500;
}
.text-gradient-from-orange-500 {
