  ...
  <section class="overflow-hidden py-20 bg-gradient-to-b from-black to-gray-900">
    <div class="container px-4 mx-auto">
      ...
      <div class="mx-auto mb-16 max-w-3xl text-center" data-aos="fade-up">
        ...
        <p class="text-lg text-gray-400">Capturing moments of innovation, learning, and success</p>
      </div>

      <!-- Gallery Grid -->
      <div class="space-y-16">
        <div v-for="(category, index) in galleries" :key="index" class="space-y-6">
          <!-- Category Title -->
          <h3
          ...
          <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <!-- Overlay -->
              <div
                class="absolute inset-0 bg-gradient-to-t from-gray-900 to-transparent opacity-0 transition-opacity duration-300 via-gray-900/60 group-hover:opacity-100"
              >
      ...
      >
        <div class="relative w-full max-w-4xl" @click.stop>
          ...
          />
          <div
            class="absolute right-0 bottom-0 left-0 p-6 bg-gradient-to-t to-transparent from-black/80"
          >
